...
graph LR
    ...
    subgraph "애플리케이션 계층"
        FUNC_BUILD["BuildDigest<br/>.NET 8 Function<br/>(통합 처리 엔진)"]
        FUNC_LEGACY["레거시 Functions<br/>(GetRecentPosts, ListRssFeedItems 등)"]
    end
    ...
    subgraph "외부 서비스"
        RSS[RSS 피드<br/>11개 소스 (Security 5, Azure 6)]
