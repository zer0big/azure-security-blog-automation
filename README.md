...
- 🛡️ Microsoft Defender Blog
- 🌐 Zero Trust Blog
- 🔑 Identity Blog
- ⏰ 스케줄: 매일 07:00, 19:00 (KST)

#### **워크플로우 #2: Azure/Cloud Blog (7개 피드)**
- ☁️ Azure Blog
- 🔧 Azure DevOps Blog
- 📊 Fabric Blog
...
graph TB
    ...
    subgraph "Logic App #1: Security"
        ...
        RSS3[MS Defender Blog]
        RSS4[Zero Trust Blog]
        RSS5[Identity Blog]
    end
    ...
    subgraph "Logic App #2: Azure/Cloud"
        ...
        RSS6[Azure Blog]
        RSS7[Azure DevOps Blog]
        RSS8[Fabric Blog]
        RSS9[Azure Infrastructure]
        RSS10[M365 Dev Blog]
        RSS11[Power Platform]
        RSS12[Azure AI Foundry]
    end
    ...
    LA2 --> RSS6 & RSS7 & RSS8 & RSS9 & RSS10 & RSS11 & RSS12
    RSS1 & RSS2 & RSS3 & RSS4 & RSS5 --> F1
    RSS6 & RSS7 & RSS8 & RSS9 & RSS10 & RSS11 & RSS12 --> F1
    F1 --> STORAGE
    F1 --> AOAI
    F1 --> F2
    F2 --> F3
...
- **Logic App (Consumption) × 2**: 워크플로우 오케스트레이션
  - Security Workflow: 5개 피드 (07:00, 19:00 KST)
  - Azure/Cloud Workflow: 7개 피드 (08:00, 20:00 KST)
...
�️ Microsoft Security Blog: No new posts in last 24 hours
🔐 Microsoft Sentinel Blog: No new posts in last 24 hours
...
```
